...
model = SelectFromModel(rf_fit, threshold=0.00001, prefit=True, max_features=N2)
...
if training_method == 'RF':
    ...
    rf_estimator = RandomForestRegressor(bootstrap=True, max_samples=3000, max_features='auto', min_samples_split=2, n_estimators=100, verbose=0, random_state=42, n_jobs=6)
