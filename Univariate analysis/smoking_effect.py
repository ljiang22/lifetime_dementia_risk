...
data_input_edit2 = data_input[(data_input.Age > 55.0) & (data_input.Age < 980) &
                    (data_input.Race==1) & (data_input.SMOKYRS<20.0)]
data_input_edit3 = data_input[ (data_input.Age > 55.0) & (data_input.Age < 90) &
                    (data_input.Race==1) & (data_input.SMOKYRS>=20.0)]
...
colors =['black', 'r']
labels = ['Year of smoking < 20.0', 'Year of smoking >= 20.0']
