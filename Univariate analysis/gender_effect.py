...
data_input_edit2 = data_input[(data_input.Age > 75.0) & (data_input.Age < 80) &
                    (data_input.Race==1) & (data_input.BMI > 25.0) & (data_input.BMI < 35.0) & (data_input['M/F']==0)]
data_input_edit3 = data_input[ (data_input.Age > 75.0) & (data_input.Age < 80) &
                    (data_input.Race==1) & (data_input.BMI > 25.0) & (data_input.BMI < 35.0) & (data_input['M/F']==1)]
...
bx.hist(attr_all, bins=8, normed=True, color=colors, histtype='bar', label=labels)
