...
data_input_edit2 = data_input[(data_input.Age > 70.0) & (data_input.Age < 90) &
                    (data_input.Race==1) & (data_input.GDS>=7.0)]
data_input_edit3 = data_input[ (data_input.Age > 70.0) & (data_input.Age < 90) &
                    (data_input.Race==1) & (data_input.GDS<7.0)]

attr = data_input_edit3['cdr']
attr1 = data_input_edit2['cdr']
attr_all = []
...
attr = data_input_edit2['DEP2YRS']
attr1 = data_input_edit3['DEP2YRS']
attr_all = []
