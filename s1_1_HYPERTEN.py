...
data_input_edit2 = data_input[(data_input.Age > 75.0) & (data_input.Age < 90) &
                    (data_input.Race==1) & (data_input.HYPERTEN == 0.0)]
data_input_edit3 = data_input[ (data_input.Age > 75.0) & (data_input.Age < 90) &
                    (data_input.Race==1) & (data_input.HYPERTEN>=0.0)]
...
colors =['black', 'r']
labels = ['Non-hypertension', 'Hypertension']
