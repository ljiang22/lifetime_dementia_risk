...
data_input_edit2 = data_input[(data_input.Age > 75.0) & (data_input.Age < 80) &
                    (data_input.Race==1) & (data_input.BMI > 25.0) & (data_input.BMI < 35.0) & (data_input.Hand==1.0)]
data_input_edit3 = data_input[ (data_input.Age > 75.0) & (data_input.Age < 80) &
                    (data_input.Race==1) & (data_input.BMI > 25.0) & (data_input.BMI < 35.0) & (data_input.Hand==2.0)]
