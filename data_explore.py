...
data_input_edit = data_input[(data_input.cdr >= 0.5) & (data_input.cdr <= 2.0)]
...
#bx.invert_yaxis()
#bx.grid()
bx.locator_params(axis='x', nbins=3)
bx.set_xlabel("Age")
bx.set_ylabel("Count")
...
f, bx = plt.subplots(nrows=1, ncols=1)
bx.hist(data_input_edit['Hand'], bins=10, color='black')
#bx.hist(data_input['Hand'], bins=10, color='r')
#bx.legend()
#bx.set_ylim(ztop, zbot)
#bx.invert_yaxis()
#bx.grid()
bx.locator_params(axis='x', nbins=3)
bx.set_xlabel("Handness")
bx.set_ylabel("Count")

f, bx = plt.subplots(nrows=1, ncols=1)
bx.hist(data_input_edit['M/F'], bins=10, color='black')
#bx.hist(data_input['M/F'], bins=10, color='r')
#bx.legend()
#bx.set_ylim(ztop, zbot)
#bx.invert_yaxis()
#bx.grid()
...
f, bx = plt.subplots(nrows=1, ncols=1)
bx.hist(data_input['Age'], bins=10, color='r')
#bx.legend()
#bx.set_ylim(ztop, zbot)
#bx.invert_yaxis()
#bx.grid()
